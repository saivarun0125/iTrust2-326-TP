...
public class Patient extends User {
    ...
    private List<CovidVaccine> vaccinesRecieved;
    ...
    public List<CovidVaccine> getVaccinesRecieved () {
        return this.vaccinesRecieved;
    }

    public void setVaccinesRecieved ( List<CovidVaccine> vaccinesRecieved ) {
